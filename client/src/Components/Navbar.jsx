...
function Navbar() {
  ...
  //checking token and replacing login sign button into profile button
        ...
        <div className="flex items-center justify-between px-6 md:px-10 py-1">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link to={token ? "/profile" : "/login"}>
              <button className="bg-cyan-950 text-white px-3 py-2 rounded-full font-semibold text-xs duration-300 hover:bg-cyan-700">
            ...
            {token && (
              <button
                className="bg-cyan-950 text-white px-5 py-2 rounded-full font-semibold text-xs duration-300 hover:bg-cyan-700"
